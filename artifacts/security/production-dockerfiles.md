...
- Generated at UTC: `2026-09-25T05:10:42Z`
- Strict mode: `true`
...
| `platform/portal-web` | APT cache cleanup | TERMINÉ | `apk-based build (alpine), no apt cache` |
...
| `services-laravel/auth-users-service` | APT cache cleanup | TERMINÉ | `apk-based build (alpine), no apt cache` |
...
| `services-laravel/chatbot-manager-service` | APT cache cleanup | TERMINÉ | `apk-based build (alpine), no apt cache` |
...
| `services-laravel/conversation-service` | APT cache cleanup | TERMINÉ | `apk-based build (alpine), no apt cache` |
...
| `services-laravel/audit-security-service` | APT cache cleanup | TERMINÉ | `apk-based build (alpine), no apt cache` |
