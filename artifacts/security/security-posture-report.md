...
- Generated at UTC: `2026-09-22T13:21:47Z`
...
|---|---|---|
| Semgrep SAST | `TERMINÉ` | `security/reports/semgrep.json`, findings=3 |
...
| Trivy filesystem scan | `TERMINÉ` | `security/reports/trivy-fs.json`, vulnerabilities=49 |
| Trivy image scan | `TERMINÉ` | `artifacts/release/image-scan-summary.txt` |
| SBOM Syft | `TERMINÉ` | `artifacts/release/sbom-summary.txt`, sbom_count=5, expected=5 |
...
| Cosign verify | `TERMINÉ` | `artifacts/release/verify-summary.txt` |
| Digest promotion | `TERMINÉ` | `artifacts/release/promotion-digests.txt` |
...
| Runtime image rollout proof | `TERMINÉ` | `artifacts/validation/runtime-image-rollout-proof.md` |
...
| Production Dockerfiles | `FAIL` | `artifacts/security/production-dockerfiles.md` |
