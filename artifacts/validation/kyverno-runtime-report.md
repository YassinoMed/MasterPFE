...
- Generated at UTC: `2026-07-18T13:19:31Z`
...
| Kyverno deployments | PARTIEL | not ready: kyverno-admission-controller=0/0/1 |
| Kyverno Audit policies | PRÊT_NON_EXÉCUTÉ | missing policies: securerag-require-pod-security |
| Kyverno PolicyReports | PARTIEL | reports=68; pass=285; warn=0; fail_or_error=3 |
...
kyverno-admission-controller    0/1     1            0           24d   registry-proxy,kyverno   alpine/socat:latest,reg.kyverno.io/kyverno/kyverno:v1.16.2   app.kubernetes.io/component=admission-controller,app.kubernetes.io/instance=kyverno,app.kubernetes.io/part-of=kyverno
kyverno-background-controller   1/1     1            1           24d   controller               reg.kyverno.io/kyverno/background-controller:v1.16.2         app.kubernetes.io/component=background-controller,app.kubernetes.io/instance=kyverno,app.kubernetes.io/part-of=kyverno
kyverno-cleanup-controller      1/1     1            1           24d   controller               reg.kyverno.io/kyverno/cleanup-controller:v1.16.2            app.kubernetes.io/component=cleanup-controller,app.kubernetes.io/instance=kyverno,app.kubernetes.io/part-of=kyverno
kyverno-reports-controller      1/1     1            1           24d   controller               reg.kyverno.io/kyverno/reports-controller:v1.16.2            app.kubernetes.io/component=reports-controller,app.kubernetes.io/instance=kyverno,app.kubernetes.io/part-of=kyverno
```
...
kyverno-admission-controller-5c499d5d68-h5hrf    1/2     Running     25 (6m15s ago)   13h   10.244.0.16    securerag-dev-worker   <none>           <none>
kyverno-background-controller-597846f7cb-tqq64   0/1     Completed   27 (13m ago)     41h   10.244.0.69    securerag-dev-worker   <none>           <none>
kyverno-cleanup-controller-66b59d96b7-sdlw7      1/1     Running     27 (11m ago)     41h   10.244.0.206   securerag-dev-worker   <none>           <none>
kyverno-reports-controller-9c89d8649-d79gg       1/1     Running     25               41h   10.244.0.35    securerag-dev-worker   <none>           <none>
```
...
securerag-restrict-image-references        true        true         False   24d                      3          0        0          0               Not Ready
securerag-restrict-service-exposure        true        true         False   24d                      1          0        0          0               Not Ready
...
securerag-verify-image-signature-keyless   true        false        False   13h                      0          0        0          1               Not Ready
```
