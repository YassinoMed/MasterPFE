...
- Generated at UTC: `2026-07-31T18:19:44Z`
...
| Bloc A | HPA runtime sans `<unknown>` | PARTIEL | P1 | Rejouer `make hpa-runtime-proof` après installation ou réparation de metrics-server. |
...
- `PARTIEL`: 7
- `PRÊT_NON_EXÉCUTÉ`: 5
- `DÉPENDANT_DE_L_ENVIRONNEMENT`: 1
