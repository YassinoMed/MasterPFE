...
| Release attestation | READ_ONLY | OK | `artifacts/final/release-attestation.log` |
...
| Observability snapshot | READ_ONLY | OK | `artifacts/final/observability-snapshot.log` |
| Portal service connectivity | READ_ONLY | OK | `artifacts/final/portal-service-connectivity.log` |
| Global project status | READ_ONLY | OK | `artifacts/final/global-project-status.log` |
