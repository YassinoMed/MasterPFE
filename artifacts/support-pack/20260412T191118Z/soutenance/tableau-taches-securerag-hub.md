...
- TERMINÉ : socle demo, portail Blade connecté avec fallback, quatre services Laravel métier, tests Laravel, contrats OpenAPI, preuves non destructives, chapitre 1 référencé.
