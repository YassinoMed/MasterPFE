...
- Generated at: `2026-04-12T22:25:45Z`
...
|---|---|---:|---:|---|
| Phase 1 runtime | Jenkins webhook readiness | READ_ONLY | PARTIEL | `artifacts/final/phase-1-runtime-jenkins-webhook-readiness.log` |
...
| Phase 2 supply chain | SBOM Cosign digest no rebuild execute | MUTATING_RELEASE | PARTIEL | `artifacts/final/phase-2-supply-chain-sbom-cosign-digest-no-rebuild-execute.log` |
