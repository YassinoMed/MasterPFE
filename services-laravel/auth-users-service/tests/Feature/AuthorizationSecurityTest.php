...
class AuthorizationSecurityTest extends TestCase
{
    ...
    public function test_mutating_user_endpoint_requires_authorization_when_testing_bypass_is_disabled(): void
    {
    ...
    public function test_mutating_user_endpoint_accepts_configured_service_token(): void
    {
        $this->setAuthzTestingBypass('false');
