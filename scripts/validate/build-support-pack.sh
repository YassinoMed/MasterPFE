...
copy_file_if_present "docs/runbooks/devsecops-closure.md" "docs/devsecops-closure.md"
...
copy_file_if_present "docs/runbooks/secrets-rotation.md" "docs/secrets-rotation.md"
copy_file_if_present "docs/runbooks/production-slo-and-alerting.md" "docs/production-slo-and-alerting.md"
...
copy_file_if_present "docs/security/secrets-strategy.md" "docs/secrets-strategy.md"
...
copy_file_if_present "docs/devsecops/feedback-loop.md" "docs/feedback-loop.md"
copy_file_if_present "docs/security/dast-roadmap.md" "docs/dast-roadmap.md"
copy_file_if_present "docs/security/runtime-security.md" "docs/runtime-security.md"
copy_file_if_present "docs/security/secrets-management.md" "docs/secrets-management.md"
copy_file_if_present "docs/security/kyverno-enforce-decision.md" "docs/kyverno-enforce-decision.md"
copy_file_if_present "docs/runbooks/observability-guide.md" "docs/observability-guide.md"
copy_file_if_present "security/semgrep/semgrep.yml" "security/semgrep.yml"
copy_file_if_present ".gitleaks.toml" "security/gitleaks.toml"
copy_tree_if_present "security/reports" "security-reports"

copy_file_if_present "infra/secrets/sops/README.md" "secrets/sops-README.md"
copy_file_if_present "infra/secrets/sops/sops-age.example.yaml" "secrets/sops-age.example.yaml"
copy_file_if_present "infra/secrets/production/securerag-database-secrets.template.yaml" "secrets/securerag-database-secrets.template.yaml"
copy_file_if_present "infra/secrets/external-secrets/README.md" "secrets/external-secrets-README.md"
copy_file_if_present "infra/secrets/external-secrets/cluster-secret-store.vault.template.yaml" "secrets/cluster-secret-store.vault.template.yaml"
copy_file_if_present "infra/secrets/external-secrets/securerag-database.external-secret.template.yaml" "secrets/securerag-database.external-secret.template.yaml"
