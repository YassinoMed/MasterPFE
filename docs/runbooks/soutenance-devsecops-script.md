...
- état du job Jenkins ;
- commit poussé retrouvé dans le dernier build Jenkins si l'API Jenkins est accessible ;
...
cat artifacts/final/devsecops-final-proof.md
cat artifacts/final/devsecops-readiness-report.md
```

Preuves attendues :

- `devsecops-final-proof.md` ;
