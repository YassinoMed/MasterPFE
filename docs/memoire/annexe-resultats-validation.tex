...
Cette annexe consolide les principaux resultats obtenus sur \textit{SecureRAG Hub} lors des campagnes de validation locale. Elle est concue pour etre reutilisee telle quelle en soutenance afin de presenter, de maniere synthetique et verifiable, l'etat reel de la plateforme, les comportements attendus et les ecarts observes.
