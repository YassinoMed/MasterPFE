...
Ce test verifie que les six images sont correctement detectees et inventoriees.
...
\begin{itemize}
  \item \texttt{artifacts/sbom/api-gateway-sbom.cdx.json}
  \item \texttt{artifacts/sbom/auth-users-sbom.cdx.json}
  \item \texttt{artifacts/sbom/chatbot-manager-sbom.cdx.json}
  \item \texttt{artifacts/sbom/llm-orchestrator-sbom.cdx.json}
  \item \texttt{artifacts/sbom/security-auditor-sbom.cdx.json}
  \item \texttt{artifacts/sbom/knowledge-hub-sbom.cdx.json}
